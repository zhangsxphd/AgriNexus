...
export const monitoringData = {
  ...
  seasonMetrics: [
    { label: '田面水位', value: '1.2', unit: 'cm', status: '正常', tone: 'sky', series: buildTrend(1.8, -0.08, 0.16) },
    { label: '土壤张力', value: '-24', unit: 'kPa', status: '正常', tone: 'teal', series: buildTrend(-18, -0.8, 1.1) },
    { label: '水温', value: '26.2', unit: '°C', status: '正常', tone: 'sky', series: buildTrend(24.4, 0.2, 0.12) },
    { label: '地温 5/10/20 cm', value: '27.8 / 27.1 / 26.3', unit: '°C', status: '正常', tone: 'amber', series: buildTrend(26.1, 0.18, 0.15) },
    { label: '空气温度', value: '29.4', unit: '°C', status: '正常', tone: 'amber', series: buildTrend(24.6, 0.72, 0.3) },
    { label: '空气湿度', value: '76', unit: '%', status: '正常', tone: 'emerald', series: buildTrend(83, -1.1, 0.5) },
    { label: 'CO₂', value: '526', unit: 'ppm', status: '正常', tone: 'slate', series: buildTrend(480, 5, 4) },
    { label: 'PAR', value: '1280', unit: 'μmol·m⁻²·s⁻¹', status: '正常', tone: 'amber', series: buildTrend(880, 46, 28) },
    { label: '风速', value: '1.4', unit: 'm/s', status: '正常', tone: 'slate', series: buildTrend(1.1, 0.05, 0.1) },
    { label: '降雨', value: '2.4', unit: 'mm', status: '正常', tone: 'sky', series: [0.2, 0.4, 0, 0.7, 0.1, 0.4, 0.3, 0.3] },
    { label: 'pH', value: '6.52', unit: '', status: '正常', tone: 'slate', series: buildTrend(6.4, 0.02, 0.03) },
    { label: 'EC', value: '1.38', unit: 'mS/cm', status: '正常', tone: 'emerald', series: buildTrend(1.46, -0.02, 0.02) },
    { label: 'NPK', value: '126 / 41 / 92', unit: 'mg/kg', status: '正常', tone: 'violet', series: buildTrend(112, 2.5, 3.5) },
  ],
  deviceStatus: [
